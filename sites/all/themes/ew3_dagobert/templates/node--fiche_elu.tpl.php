 ...
 <table width="100%" border="0" summary="" class="table_fiche_elu">
  ...
  <?php print render($content['field_elu_photo']); ?>
         ...
         <td class="td_fiche_elu">
            <?php print render($content['field_elu_commune']); ?>
             <div class="clear separator-label-elu"></div>
            <?php print render($content['field_elu_qualite']); ?>
             <div class="clear separator-label-elu"></div>
            <?php print render($content['field_elu_representation']); ?>
         </td>
    </tr>
 </table>
  <?php
